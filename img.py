...
def win_col(max_value,min_val,name):
    global image,hsvimage,kernel
    mask = cv2.inRange(hsvimage, max_value, min_val)
...
win_col(np.array([23,60,0]),np.array([31,255,255]),"Yellow")
win_col(np.array([179,255,255]),np.array([170,0,0]),"Blue")
win_col(np.array([10,96,0]),np.array([15,255,255]),"Orange")
